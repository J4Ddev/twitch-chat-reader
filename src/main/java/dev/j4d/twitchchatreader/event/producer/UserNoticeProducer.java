...
@Component
public class UserNoticeProducer {

    private static final Logger logger = LoggerFactory.getLogger(UserNoticeProducer.class);

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final String topic;

    public UserNoticeProducer(KafkaTemplate<String, String> kafkaTemplate, @Value("${kafka.topic.user-notice.name}") String topic) {
