...
public class PresenceProducer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PresenceProducer.class);

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final String topic;

    public PresenceProducer(KafkaTemplate<String, String> kafkaTemplate, @Value("${kafka.topic.presence.name}") String topic) {
