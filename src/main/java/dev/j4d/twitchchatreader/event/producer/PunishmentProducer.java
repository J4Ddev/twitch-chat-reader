...
@Component
public class PunishmentProducer {

    private static final Logger logger = LoggerFactory.getLogger(PunishmentProducer.class);

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final String topic;

    public PunishmentProducer(KafkaTemplate<String, String> kafkaTemplate, @Value("${kafka.topic.punishment.name}") String topic) {
